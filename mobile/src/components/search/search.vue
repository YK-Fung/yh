    ...
    export default {
        ...
        methods: {
            ...
            _submit(ctn) {
                ...
                this.searchParams = {sortFlag: 1, searchText: this.tempCtn, agentType: '', brandName: '', pageNo: 1};
        ...
        created() {
            if(this.$route.query.sortFlag == 1){
              this.nav =  [
                    {tap: true, icon: false},
                    {tap: false, icon: false},
                    {tap: false, icon: false},
            ...
            }else if(this.$route.query.sortFlag == 2){
                this.nav =  [
                    {tap: false, icon: false},
                    {tap: true, icon: true},
                    {tap: false, icon: false},
            ...
            }else if(this.$route.query.sortFlag == 3){
                this.nav =  [
                    {tap: false, icon: false},
                    {tap: true, icon: false},
                    {tap: false, icon: false},
            ...
            }else if(this.$route.query.sortFlag == 4){
                this.nav =  [
                    {tap: false, icon: false},
                    {tap: false, icon: false},
                    {tap: true, icon: true},
        ...
        mounted() {
            ...
            this.catName = this.searchParams.catName ? this.searchParams.catName : '';
            this.catGrade = this.searchParams.catGrade ? this.searchParams.catGrade : '';
            this._ajaxFn(this.searchParams);
